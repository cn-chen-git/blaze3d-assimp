...
class AIMat4(val m: FloatArray = floatArrayOf(1f,0f,0f,0f, 0f,1f,0f,0f, 0f,0f,1f,0f, 0f,0f,0f,1f)) {
    operator fun times(o: AIMat4): AIMat4 { val r = AIMat4(FloatArray(16)); mulInto(o, r); return r }
    fun mulInto(o: AIMat4, out: AIMat4) {
    ...
    fun copyFrom(o: AIMat4) { System.arraycopy(o.m, 0, m, 0, 16) }
    fun setIdentity() { val r = m; r[0]=1f;r[1]=0f;r[2]=0f;r[3]=0f; r[4]=0f;r[5]=1f;r[6]=0f;r[7]=0f; r[8]=0f;r[9]=0f;r[10]=1f;r[11]=0f; r[12]=0f;r[13]=0f;r[14]=0f;r[15]=1f }
    ...
    fun inverse(): AIMat4 { val r = AIMat4(FloatArray(16)); inverseInto(r); return r }
    fun inverseInto(out: AIMat4): Boolean {
        val inv = out.m
